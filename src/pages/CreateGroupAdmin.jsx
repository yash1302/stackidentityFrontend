  ...
  return (
    ...
    <div className="h-screen w-full flex-col ml-[14px] justify-center">
      ...
      <div className="flex justify-end gap-20 my-[22px] mr-[27px]">
        <Button variant="contained" size="small"style={{padding:'10px 15px'}}>Cancel</Button>
        <Button variant="contained" size="small" style={{padding:'10px 15px'}}>Create Group</Button>
      </div>
    </div>
    </div>
  );
